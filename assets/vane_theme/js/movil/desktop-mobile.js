...
document.getElementsByTagName('head')[0].appendChild(viewPortTagDefault);if(typeof ios_fix=="function"){ios_fix()}}
...
{createCookie(name,"",-1);}
function toDeskTop(){var isMobile=navigator.userAgent.match(/(iPhone)|(iPod)|(android)|(Windows Phone)|(BlackBerry)|(iemobile)|(symbian)|(BB10)|(PlayBook)|(webOS)/i)
