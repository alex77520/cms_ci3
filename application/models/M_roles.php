...
class M_roles extends CI_Model {
	...
	var $table = 'rol';
	var $column_order = array('name','description',null); //set column field database for datatable orderable
	...
	var $order = array('id_rol' => 'desc'); // default order 
...
/* Location: ./application/models/M_roles.php */