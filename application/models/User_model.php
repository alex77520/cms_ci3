...
class User_model extends CI_Model {
	...
	var $table = 'user';
	var $column_order = array('first_name','last_name','email','username','password','status','created',null); //set column field database for datatable orderable
