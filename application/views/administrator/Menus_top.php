        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <button class="pull-right btn btn-primary" onclick="add_menus_top()"><i class="glyphicon glyphicon-plus"></i>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Agregar Menu superior</h4>
      </div>
