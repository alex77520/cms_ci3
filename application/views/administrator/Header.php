...
<head>
  ...
  <title>Viejo Topo</title>
    <!--get date for url-->
  <script language="javascript">
           
        // Esta funcion extrae los valores de la url
        function getValues(){
    ...
    var params = document.URL.substring(urlEnd+1, document.URL.length).split('&');
        ...
        var resultado = unescape(values["resultado"]);
  ...
  <![endif]-->
 <link href="<?php echo base_url();?>assets/dist/css/bootstrap-select.min.css" rel="stylesheet">
  <!-- Google Font -->
   
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
  <!--html for boostrap select-->
...
<div class="wrapper">
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php base_url() ?>administrator" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>V</b>TP</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Viejo</b>TOPO</span>
    </a>
